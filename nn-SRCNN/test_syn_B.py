...
if __name__ == '__main__':
    weights_file = './weight_output_syn_B/epoch_64.pth'
    upscale_factor = 2
    plus = 1
    number = 84
    print('syn data:')
    ...
    for pic_number in range(number):
        ...
        tf.imwrite(
            './pic_output_syn_B/syn_B_10x_out{}.tif'.format(pic_number+plus), preds)
    ...
    data_frame.to_csv('test_results_syn_B.csv', index_label='Epoch')
